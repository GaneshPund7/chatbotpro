...
const CardWork = ({
  ...
  return <div className="card border-0">
      ...
      <div className="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
        <Link to="/Admin/personalize" className="text-lg font-medium text-gray-900 hover:text-primary">
          {title}
        </Link>
        ...
        <div className="flex items-center justify-between grow">
          <div className="flex items-center grow">
            ...
            <Link to="/Admin/LLM-model-setup" className="text-2sm text-gray-800 hover:text-primary mb-px">
              {authorName}
            </Link>
            <p>{description}</p>
